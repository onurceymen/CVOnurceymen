        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content1 = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Content2 = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookNane = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Bookauthor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BookTour = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BookPublishingHouse = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookcases", x => x.BookID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EducationTitle1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EducationTitle2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
